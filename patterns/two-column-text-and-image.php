...
<p class="is-style-button-fill"><a href="mailto:rachel@rrvasquez.com">Email me</a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-arrow"} -->
<p class="is-style-arrow"><a href="/services">View services</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

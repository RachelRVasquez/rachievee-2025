...
<!-- wp:group {"className":"is-home-intro","style":{"spacing":{"blockGap":"0rem","margin":{"top":"0px","bottom":"0px"},"padding":{"bottom":"var:preset|spacing|60","top":"var:preset|spacing|60","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"gradient":"header-gradient","layout":{"type":"constrained","wideSize":"1400px","contentSize":"75%","justifyContent":"center"}} -->
<div class="wp-block-group is-home-intro has-header-gradient-gradient-background has-background" style="margin-top:0px;margin-bottom:0px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"textAlign":"center","animationsForBlocks":{"animation":"fade","variation":"up","mirror":true,"once":false},"style":{"spacing":{"padding":{"bottom":"0px"},"margin":{"bottom":"0px"}}},"fontSize":"5-xl","fontFamily":"playfair-display"} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1400px"}} -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic","fontWeight":"700","fontSize":"1.5rem"},"spacing":{"margin":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"textColor":"heading-secondary","fontFamily":"playfair-display"} -->
<p class="has-heading-secondary-color has-text-color has-playfair-display-font-family" style="margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40);font-size:1.5rem;font-style:italic;font-weight:700"><?php esc_html_e('I make broken things lean again. I make confusing things usable. I make slow things fast. And most importantly, I make it all accessible.', 'rachievee-2025');?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|70"}}},"layout":{"type":"flex","flexWrap":"wrap"}} -->
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70)"><!-- wp:paragraph {"className":"is-style-button-fill"} -->
<p class="is-style-button-fill"><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element */ 
echo sprintf( esc_html__( '%1$sEmail me%2$s', 'rachievee-2025' ), '<a href="' . esc_url( 'mailto:rachel@rrvasquez.com' ) . '">', '</a>' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"is-style-arrow"} -->
<p class="is-style-arrow"><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element */ 
echo sprintf( esc_html__( '%1$sView services%2$s', 'rachievee-2025' ), '<a href="' . esc_url( '/services' ) . '">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:group {"animationsForBlocks":{"animation":"","variation":"fade"},"style":{"spacing":{"margin":{"bottom":"0px"},"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|60","right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"backgroundColor":"bg-header","layout":{"type":"constrained","contentSize":"1400px"}} -->
<div class="wp-block-group has-bg-header-background-color has-background" style="margin-bottom:0px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--50)"><!-- wp:group {"tagName":"main","animationsForBlocks":{"animation":"","variation":"up"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"},"padding":{"right":"0px","left":"0px"}}},"layout":{"type":"default"}} -->
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70);padding-right:0px;padding-left:0px"><!-- wp:group {"animationsForBlocks":{"animation":"fade","variation":"up"},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
...
<!-- wp:group {"className":"is-style-full-height","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"border":{"radius":"15px"}},"backgroundColor":"body-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-full-height has-body-bg-background-color has-background" style="border-radius:15px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)"><!-- wp:post-date {"format":"F j, Y","isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-orange"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"accent-orange"} /-->

<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|post-title"}}},"typography":{"fontSize":"1.5rem","fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"var:preset|spacing|50"}}},"textColor":"post-title","fontFamily":"playfair-display"} /--></div>
<!-- /wp:group -->
